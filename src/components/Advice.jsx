...
const Advice = () => {
  ...
  return (
    ...
    <div className=' pt-8 pb-16 flex-col justify-center items-center'>
      ...
      <button onClick={update} className=' rounded-full p-4 inline-block bg-neon-green absolute right-1/2 -bottom-7 transform translate-x-1/2 hover:shadow-neon-green hover:shadow-lg z-30'>
